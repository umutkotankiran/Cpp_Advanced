...
std::scoped_lock
std::lock_guard sınıfına benziyor. Ancak sınıfın kurucu işlevi birden fazla mutex nesnesini alabiliyor. Kurucu işlev aldığı sırayla mutex nesnelerini kilitliyor. Sonlandırıcı işlev ters sırada kilitleri açıyor.
