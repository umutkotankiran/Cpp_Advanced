...
BU READY,TIMEOUT YADA DEFERRED OLABILIR. BU DEĞERLERE BAKARAK DURUM HAKKINDA BILGI ALIYORUZ.
READY ISE DEĞER HAZIR, TIMEOUT İSE SÜRE GEÇMİŞ AMA DEĞER HAZIR DEĞİL, DEFERRED İSE ZATEN
