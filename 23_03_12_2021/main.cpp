...
C++20 İLE GELEN YENİLİKLER
--------------------------
6 TANE FUNC YAZDIK. AMA HER DURUMDA ASLINDA YAZDIĞIMIZ 2 FUNCTİON VAR( < ve ==) BUNLARI ÇAĞIRARAK
DİĞER 4 FUNC İŞİNİ GÖRÜYOR.

KODLARI DERLEYİCİ YAZABİLİR ASLINDA. DERLEYİCİ BUNUN KODUNU BENİM İÇİN YAZ DİYEBİLİYORUZ.
ÇOK DURUMDA HİÇ KOD YAZMADAN 6 TANE KARŞILAŞTIRMA OPERATÖRÜNÜDE EDİNMİŞ OLUYORUZ
<=> SPACESHIP OPERATORUNU DEFAULT EDEREK.BİR ÇOK DURUMDA BU TÜR DÖNÜŞÜMÜYLE EXPLICIT OLMAYAN CTORUN KULLANILMASI DURUMUNDA
İLAVE GLOBAL OPERATOR FUNC YAZMAMIZA GEREK KALMIYOR. HATTA YENİ GELEN ARAÇLA GLOBAL OPERATOR FUNC OLMASININ AVANTAJIDA
KALMIŞ OLUYOR.
...
int main()
{
	...
	cout << (13 == n1) << "\n"; // C++20 DE DERLEYİNCE GEÇERLİ.SENTAKS HATASIYDI BU C++17 de. SOL OPERAND SINIF TURDEN DEĞİL.
...
3. operator=='İN KENDİSİNİDE DERLEYİCİYE YAZDIRABİLİRİZ.C++20
